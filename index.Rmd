...
```{r}
fa_book <- icons::fontawesome$regular$`address-book`
github <- fontawesome$brands$github
twitter <- fontawesome$brands$twitter
```


- bcjaeger@uab.edu `r fa_book`
- [GitHub `r github`](https://github.com/bcjaeger) 
- [Twitter `r twitter`](https://twitter.com/byron_jaeger) 
